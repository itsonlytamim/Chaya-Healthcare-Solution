...
namespace Myproject
{
    public partial class Gynecologists : Form
    {
        string cs = ConfigurationManager.ConnectionStrings["dbcs"].ConnectionString;
        public Gynecologists()
        {
            InitializeComponent();
            BindGynecologistGridView();
        }
        void BindGynecologistGridView()
        {
            ...
            cmd.Parameters.AddWithValue("@designation", "GYNECOLOGIST");
        ...
        {
            this.Hide();
            UserHomePage fo = new UserHomePage();
            fo.Show();
        }
